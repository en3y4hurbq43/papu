...
var uta = L.marker([21.839114, -102.353805]);
parqueTresCenturias.bindPopup("<b>Universidad Tecnologica de Aguascalientes</b><br>Auuuuuuuuuuuuuuuuu.");

var isla = L.marker([21.862227, -102.321358]);
parqueTresCenturias.bindPopup("<b>Isla de San Marcos</b><br>Esta chido si vas en abril.");

var parquemex = L.marker([21.913810, -102.271953]);
parqueTresCenturias.bindPopup("<b>Isla de San Marcos</b><br>parque chido.");
...
var uta = L.marker([21.839114, -102.353805], {icon: customIcon6}).addTo(map);
uta.bindPopup("<b>Universidad Tecnologica de Aguascalientes</b><br><img src='img/descarga.jpg' width='200px'><br>Auuuuuuuuuuu.");

var isla = L.marker([21.862227, -102.321358], {icon: customIcon7}).addTo(map);
uta.bindPopup("<b>Isla de San Marcos</b><br><img src='img/isla.jpg' width='200px'><br>Esta chido si vas en abril.");

var parquemex = L.marker([21.913810, -102.271953], {icon: customIcon8}).addTo(map);
uta.bindPopup("<b>Isla de San Marcos</b><br><img src='img/isla.jpg' width='200px'><br>parque chido");